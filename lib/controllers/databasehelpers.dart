...
class DataBaseHelper {
  ...
  var status;
  var token;
  String serverUrlproducts = "http://192.168.1.19:3000/products";
  ...
  void addDataProducto(String _nameController, String _priceController, String _stockController) async {
   ...
   String myUrl = "http://192.168.1.19:3000/products";
  ...
  void editarProduct(String _id, String name, String price, String stock) async {
    ...
    String myUrl = "http://192.168.1.19:3000/product/$_id";
    http.put(myUrl,
        body: {
         "name":       "$name",
         "price":       "$price",
